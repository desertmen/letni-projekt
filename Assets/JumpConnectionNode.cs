...
public class JumpConnectionNode
{
    ...
    public JumpConnectionNode(WalkableChunk startPolygon, WalkableChunk destinationPolygon, Vector2 jumpStart, Tuple<JumpHit, JumpHit> interval)
    {
